...
export const ManageRegistrationsPage = () => {
  ...
  const { data: registrations, isLoading: loadingRegs } = useAdminRegistrations(selectedEvent?.id);
  ...
  const handleUpdateStatus = async (ticketId, newStatus) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        // Refresh list
        queryClient.invalidateQueries(['admin-registrations', selectedEvent.id]);
      ...
      {loadingRegs ? (
        ...
        <div className="overflow-x-auto">
            ...
            <tbody className="divide-y divide-gray-100">
                ...
                registrations && registrations.map((ticket) => (
